...
module.exports = function(app) {
    ...
    app.post('/query/', function(req, res){
        ...
        var sporttypes      = req.body.sporttypes;
        var spotseasons     = req.body.spotseasons;
        ...
        if(sporttypes){
            query = query.where('sporttypes').in(sporttypes);
        }

        if(spotseasons){
            query = query.where('spotseasons').in(spotseasons);
        }
